...
\fancyhead[R]{\textit{\small\color{gray} PhD in Economics and Finance: Application Guide}}
...
\begin{enumerate}[leftmargin=*, itemsep=3pt, label={\color{cprimary}\bfseries\arabic*.}]
    ...
    \item \hyperref[sec:departments]{Selecting Departments}
    ...
    \item \hyperref[sec:llm]{Use of LLMs in Writing}
...
Almost all PhD programs require the GRE General Test. The \textbf{Quantitative Reasoning} score is the most critical component. A strong quantitative score (166 and above) will put you in a competitive position at most programs. The Verbal and Analytical Writing sections matter (these are signals) for economics and still complement your overall profile.
...
Most programs require \textbf{three letters of recommendation}. These are among the most important components of your application. Strong letters come from faculty who know your academic work well and can speak to your research potential. Recommendation letters carry more weight than other components. 

\begin{enumerate}[leftmargin=*, itemsep=2pt]
    \item Choose recommenders who can specifically speak about your analytical abilities, intellectual curiosity, and capacity for independent research.
    \item Ideally, at least two letters should come from professors or researchers {economics/finance} you have worked closely with.
    \item Letters comparing you to previous students who have succeeded in top PhD programs are especially powerful.
    \item \textbf{Ask yourself: }does this person know my academic strengths and weaknesses? Also, how closely have you worked with this person?
\end{enumerate}
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
    \item Statement of Purpose is like storytelling. There is an arc to the story. Here are some elements. 
    
    \begin{enumerate}
        \item Start with this question: what made you choose economics/finance research? 
        \item How is your research experience an addition to your quest so far? 
        \item Talk about your background and how a PhD program will shape you by sharing some of the ideas you plan to pursue during the PhD. 
        *Most likely you will end up doing something else than what you have written, but write some good research ideas.
    \end{enumerate}
    ...
    \item Keep it focused and concise (typically 2-3 pages). I think some schools ask for only 2 page SoP but most of them are okay with 3 pages. 
\end{itemize}
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
    ...
    \item Working papers (if applicable)
    \item Technical skills (programming languages: R, Stata, Python, MATLAB, etc.): LLMs have largely closed the gap in technical writing skills. When everyone can produce polished prose, polish alone stops being a signal. What stands out now is originality of thought. Focus on being creative with your ideas rather than perfecting the surface.
    \item Honors, awards, and fellowships
\end{itemize}

\begin{tipbox}[Working Papers: A Competitive Advantage]
While not required, having a working paper or a senior thesis that demonstrates research execution can significantly strengthen your application. As Susan Athey notes, for applicants to top programs an outstanding thesis can be a key differentiator especially when paired with strong coursework and recommendations. If you have a co-authored paper with a faculty member include it prominently.
\end{tipbox}
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
    \item \textbf{Faculty fit.} Look for departments with active faculty in your area of interest. One thing to keep in mind that many tenured track faculty move to other departments. If you can find many faculty members working in the areas that you are interested then definitely keep that department in the list. Don't do a narrow search (in computer science we call it Depth First Search and Breadth First Search so apply BFS then DFS). 
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
    ...
    \item Create a normal curve: a few \textbf{``reach''} programs, several \textbf{``match''} programs where your profile fits well, and a couple of `\textbf{`safety''} programs.
    \item Keep in mind that application fees add up. Budget for \$75 to \$150 per school and look into fee waivers early (\hyperref[sec:fees]{Section 9}). 
    ...
    \item ***Ask your recommenders/mentors (Letter Writers) for advice on your school list. Faculty who have served on admissions committees can help you calibrate where you are likely to be competitive.
\end{itemize}
...
% ============= SECTION 6 =============
\section{Use of LLMs in Writing}\label{sec:llm}

Large language models like ChatGPT and Claude are widely available and it is tempting to use them to draft application essays. I think using an LLM to write the entire script of your Statement of Purpose or Personal Statement is not a good idea.

Admissions committees are reading for your voice, your research story, and your way of thinking about problems. An LLM-generated essay tends to sound polished but generic, and experienced readers can often tell. More importantly, the process of writing your SoP is itself valuable because it forces you to clarify your own thinking about why you want a PhD and what you want to work on.

Where LLMs genuinely help is with grammar, sentence structure, and clarity. If English is not your first language, using an LLM to clean up awkward phrasing is perfectly reasonable. You can also use it to check whether your argument flows logically or to get feedback on whether a paragraph is unclear.

\begin{tipbox}[The Right Way to Use LLMs]
Think of an LLM as a writing tutor, not a ghostwriter. Use it to:
\begin{itemize}[leftmargin=*, itemsep=2pt]
    \item Check grammar and fix awkward sentences
    \item Reframe a paragraph that feels clunky
    \item Get feedback on whether your argument is clear
    \item Brainstorm how to structure your essay (but write the actual content yourself)
\end{itemize}
Do not use it to:
\begin{itemize}[leftmargin=*, itemsep=2pt]
    \item Draft entire essays or large sections from scratch
    \item Generate research ideas that you have not actually thought about
    \item Produce a voice that is not yours
\end{itemize}
\end{tipbox}

This applies equally to the Diversity Statement and Personal Statement. Those documents are even more personal than the SoP, so having an LLM write them would be particularly counterproductive.
...
If you are a Delhi University graduate then arrange your transcript early. It takes 21 working days in delivery. 
...
Application fees typically range from \$75 to \$150 per program, which can add up quickly if you are applying to 15 to 20 schools. Fortunately, many programs offer fee waivers.
...
\midrule
\rowcolor{clight} \textbf{Total (estimated for 15 schools)} & \textbf{\$2,500--\$3,500+} & & \\
\bottomrule
\end{tabular}
\end{center}
\vspace{6pt}
...
Start looking into fee waivers early. Between GRE, TOEFL, and application fees alone, applying to 15 schools can easily exceed \$2,500. Many of these costs can be reduced or eliminated with fee waivers and score-sending offers.
\end{tipbox}
...
{\normalsize Start early, and remember to seek help. Research is a collaborative process and it begins here. }
\vspace{10pt}
\end{minipage}%
}
\end{center}

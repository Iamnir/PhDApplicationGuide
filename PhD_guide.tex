...
% ---- Highlight Box (for key stats / callouts) ----
...
\vspace{14pt}
\centering
{\Huge\bfseries\color{white} PhD in Economics}\\[8pt]
...
\begin{enumerate}[leftmargin=*, itemsep=1pt]
    \item Core components of Application Process: GRE, TOEFL, CV, SoP, LoR
    \item Choosing Economics Departments
    \item Building Your School List
    \item Selecting Your Letter Writers
    \item Diversity Statement and Personal Statement
    \item Preparing for Interviews
    \item *Documents required:
    \begin{enumerate}[label=\arabic{enumi}.\arabic*, itemsep=1pt]
        \item Transcripts and Grade Conversion
        \item List of related coursework
    \end{enumerate}
    \item Application Fees and Fee Waivers
    \item Appendix
    \begin{enumerate}[label=\arabic{enumi}.\arabic*, itemsep=1pt]
        \item Curated Resources \& Further Reading 
        \item Final Application Checklist 
...
% ============= SECTION 1 =============
\section{Core Application Materials}
...
% ============= SECTION 2 =============
\section{Choosing Economics Departments}
...
\newpage
% ============= SECTION 3 =============
\section{Building Your School List}
...
This figure is just to give you an idea of acceptance rate. In reality, each schools make their decision independently. The probability of acceptance at any single school is going to change by school type. 
% ============= SECTION 4 =============
\section{Selecting Your Letter Writers}
...
% ============= SECTION 5 =============
\section{Diversity Statement and Personal Statement}
...
% ============= SECTION 6 =============
\section{Preparing for Interviews}
...
\subsection{Transcripts and Grade Conversion}
...
\subsection{List of Related Coursework}
...
% ============= SECTION 8 =============
\section{Application Fees and Fee Waivers}
...
% ============= CURATED RESOURCES =============
\section{Curated Resources \& Further Reading}

The following resources are widely recommended by faculty, mentors, and successful applicants.

\subsection{Application Advice Sources and Mentorship Program}
...
\newpage
% ============= FINAL CHECKLIST =============
\subsection{Final Application Checklist}
...
\newpage
% ============= EXPENSE TRACKER =============
\subsection{Application Expense Tracker}
